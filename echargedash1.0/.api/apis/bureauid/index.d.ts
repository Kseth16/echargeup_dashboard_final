...
declare class SDK {
     ...
     */
    iPAttributes(body: types.IPAttributesBodyParam): Promise<FetchResponse<200, types.IPAttributesResponse200>>;
    /**
     ...
     */
    aml_pep_sanctions_screening_v1(body: types.AmlPepSanctionsScreeningV1BodyParam): Promise<FetchResponse<200, types.AmlPepSanctionsScreeningV1Response200>>;
    /**
     * Unleash the power of due diligence with our Anti-Money Laundering (AML) and Politically
     * Exposed Persons (PEPs) API. Our API delivers detailed, real-time profiles that include
     * biographical information, connections, past and present positions, negative news
     ...
     */
    aml_pep_sanctions_screening_v2(body: types.AmlPepSanctionsScreeningV2BodyParam): Promise<FetchResponse<200, types.AmlPepSanctionsScreeningV2Response200>>;
    /**
     ...
     */
    complianceScreening(body: types.ComplianceScreeningBodyParam): Promise<FetchResponse<200, types.ComplianceScreeningResponse200>>;
    /**
     ...
     */
    mask_aadhaar_number(body: types.MaskAadhaarNumberBodyParam): Promise<FetchResponse<200, types.MaskAadhaarNumberResponse200>>;
    /**
     * As per government regulations, all entities, regulated or otherwise, can only store
     * masked versions of Aadhaar cards. Use this API to generate a masked version of an
     ...
     */
    mask_aadhaar_number_qr(body: types.MaskAadhaarNumberQrBodyParam): Promise<FetchResponse<200, types.MaskAadhaarNumberQrResponse200>>;
    /**
     ...
     */
    esignedSession(body: types.EsignedSessionBodyParam): Promise<FetchResponse<200, types.EsignedSessionResponse200>>;
    /**
     ...
     */
    aadhaarEsignFetch(body: types.AadhaarEsignFetchBodyParam): Promise<FetchResponse<200, types.AadhaarEsignFetchResponse200>>;
    /**
     * Fetch a signed document
     *
     *
     ...
     */
    aadhaarEsignRedirect(body: types.AadhaarEsignRedirectBodyParam): Promise<FetchResponse<200, types.AadhaarEsignRedirectResponse200>>;
    /**
     * Fetch a signed document
     *
     *
     ...
     */
    aadhaarEsignDelete(body: types.AadhaarEsignDeleteBodyParam): Promise<FetchResponse<200, types.AadhaarEsignDeleteResponse200>>;
    /**
     ...
     */
    accountNumberVerification(body: types.AccountNumberVerificationBodyParam): Promise<FetchResponse<200, types.AccountNumberVerificationResponse200>>;
    /**
     ...
     */
    vpa_verification_v2(body: types.VpaVerificationV2BodyParam): Promise<FetchResponse<200, types.VpaVerificationV2Response200>>;
    /**
     * This API enables you to instantly verify the validity and ownership of a Virtual Payment
     * Address (VPA) or a Unified Payments Interface (UPI) ID. Pass the VPA or UPI ID you want
     * to verify in the request and get information about the name and bank associated with the
     ...
     */
    vpa_verification_v1(body: types.VpaVerificationV1BodyParam): Promise<FetchResponse<200, types.VpaVerificationV1Response200>>;
    /**
     ...
     */
    get_ifsc_details(body: types.GetIfscDetailsBodyParam): Promise<FetchResponse<200, types.GetIfscDetailsResponse200>>;
    /**
     ...
     */
    ePFUANLookup(body: types.EPfuanLookupBodyParam): Promise<FetchResponse<200, types.EPfuanLookupResponse200>>;
    /**
     ...
     */
    ePFAuthenticationRequestOTP(body: types.EPfAuthenticationRequestOtpBodyParam): Promise<FetchResponse<200, types.EPfAuthenticationRequestOtpResponse200>>;
    /**
     * The API that authenticates the Universal Account Number (UAN) issued by Employees
     * Provident Fund Office (EPFO) in India using a six-digit OTP-based consent of the Account
     * Holder.
     ...
     */
    ePFAuthenticationRequestDetails(body: types.EPfAuthenticationRequestDetailsBodyParam): Promise<FetchResponse<200, types.EPfAuthenticationRequestDetailsResponse200>>;
    /**
     ...
     */
    credit_report_send_otp(body: types.CreditReportSendOtpBodyParam): Promise<FetchResponse<200, types.CreditReportSendOtpResponse200>>;
    /**
     * Streamline credit checks with our secure and easy-to-use credit report API. Get
     * comprehensive reports quickly using a Permanent Account Number (PAN) and the PAN
     ...
     */
    credit_report_verify_otp(body: types.CreditReportVerifyOtpBodyParam, metadata: types.CreditReportVerifyOtpMetadataParam): Promise<FetchResponse<200, types.CreditReportVerifyOtpResponse200>>;
    /**
     * Streamline credit checks with our secure and easy-to-use credit report API. Get
     * comprehensive reports quickly using a Permanent Account Number (PAN) and the PAN
     ...
     */
    credit_report_get_credit_report(body: types.CreditReportGetCreditReportBodyParam): Promise<FetchResponse<200, types.CreditReportGetCreditReportResponse200>>;
    /**
     ...
     */
    credit_report_without_consent(body: types.CreditReportWithoutConsentBodyParam): Promise<FetchResponse<200, types.CreditReportWithoutConsentResponse200>>;
    /**
     ...
     */
    creditPrefill(body: types.CreditPrefillBodyParam): Promise<FetchResponse<200, types.CreditPrefillResponse200>>;
}
